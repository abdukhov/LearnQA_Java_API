...
public class UserAgentTest {
    ...
    public void shouldResponseInAccordanceWithUserAgent(String userAgent, String platform, String browser, String device) {
        ...
        response
                .assertThat()
                .statusCode(SC_OK)
                .body("platform", is(platform))
                .body("browser", is(browser))
